  ...
  return (
    <div className='py-8 flex flex-col items-center justify-center gap-4'>
        ...
        <div className='grid grid-cols-3 gap-12 my-4'>
            <div className="p-8 flex flex-col items-center justify-center gap-4 border border-neutral-200 rounded-md shadow-lg bg-gradient-to-b from-gray-100 to-white transition-transform hover:scale-105 hover:shadow-xl duration-300">
                <Image
                    alt="Sweet coffee"
